...
With a thesis or dissertation, the format also encompasses the names of the sections that are expected: \textbf{Abstract, Acknowledgments, Nomenclature, List of Figures, List of Tables, Introduction, State-of-the-Art, Experimental Design, Experimental and Computational Results, Conclusions and Future Work, References and Appendix.}	
