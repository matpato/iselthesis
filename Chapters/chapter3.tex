...
\label{sec:floats_figures_and_captions}
 ...
 In this case, you must use the \spverb!wrapfigure! package.  To use \spverb!wrapfig!, you must first add this to the preamble:
...
\end{wrapfigure}	
 ...
 \noindent\spverb!\usepackage{wrapfig}!\\
 This then gives you access to:\\
 \spverb!\begin{wrapfigure}[lineheight]{alignment}{width}!
 \\
 Alignment can normally be either 'l' for left, or 'r' for right. Lowercase 'l' or 'r' forces the figure to start precisely where specified (and may cause it to run over page breaks), while capital 'L' or 'R' allows the figure to float. If you defined your document as \textit{twosided}, the alignment can also be 'i' for inside or 'o' for outside, as well as 'I' or 'O'. The width is obviously the width of the figure. The example above was introduced with: 
...
\centering{\textbf{Written by Matilde Pós-de-Mina Pato, \\ \today  \hspace{2em}--\version{2.5} (last version)}}
