...
\begin{description}
	...
	\begin{description}
		...
		\item \textbf{\_institution.tex} Fixed institutional data (university and school names). Only change this file if you are \textbf{not} from ISEL;
...
coverlang   &  \textbf{The language to be used when typesetting the cover page}: English -- en(*) and Portuguese -- pt.   \\  \midrule
...
\begin{itemize}
	...
	\verb!documentclass[docdegree=msc, doctype=project, lang=en,!\\
    \verb!media=screen]{iselthesis}!
\end{itemize}
