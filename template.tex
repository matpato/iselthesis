...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[msc,pt,twoside,12pt,a4paper]{thesisisel} 
...
%% Bibliography style
% ----------------------------------------------------------------------
%\bibliographystyle{plain}  % > entries ordered alphabetically

%\bibliographystyle{unsrt} % > unsorted with entries appearing in the order in which the citations appear.

%\bibliographystyle{abbrv} % > entries ordered alphabetically, with first names and names of journals and months abbreviated

%\bibliographystyle{alpha} % > entries ordered alphabetically, with reference markers based on authors' initials and publication year

% Replacement bibliography styles provided by 'natbib' package
% (plainnat.bst, abbrvnat.bst, unsrtnat.bst )
\bibliographystyle{plainnat} % > entries ordered alphabetically

%\bibliographystyle{unsrtnat} % > unsorted with entries appearing in the order in which the citations appear.

%\bibliographystyle{abbrvnat} % > entries ordered alphabetically, with first names and names of journals and months abbreviated
